...
<body class="w3-theme-l5">
  <div class="w3-top">
    ...
    <!-- khung đăng bài -->
    <div class="w3-container w3-content" style="width:80%;max-width:1400px;margin-top:80px" id="page-container">
      <div class="w3-row" style="height: 600px;">
        ...
        <div class="w3-col m9" style="width: 100%;padding: 50px auto">
          <div style="width: 100%;">
            <h1>hello jasjdasd sa fdsa fsd f sdf sd f sd f sd fsd f sd f </h1>
          </div>
        </div>
      </div>
